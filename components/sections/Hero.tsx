          ...
          <FadeIn delay={0.55}>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 sm:gap-5 pt-3 sm:pt-6">
              ...
              <button
                ...
                className="w-full sm:w-auto min-h-[48px] px-6 rounded-xl border border-white/20 text-sm font-bold text-slate-200 hover:text-white hover:border-cyan-400/60 hover:bg-cyan-500/10 transition-all flex items-center justify-center gap-2 shadow-lg"
              >
