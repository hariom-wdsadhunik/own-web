    ...
    <section className="relative min-h-[85vh] sm:min-h-[90vh] flex flex-col justify-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24 overflow-hidden">
      <div className="space-y-6 sm:space-y-8 max-w-4xl relative z-10">
        ...
        <div className="space-y-2 sm:space-y-4">
          <Reveal delay={0.2}>
            <h1 className="font-display text-3xl sm:text-7xl md:text-8xl font-bold tracking-tight text-white leading-[1.1] sm:leading-[1.05]">
              PRODUCT THINKING.
            </h1>
          </Reveal>
          <Reveal delay={0.3}>
            <h1 className="font-display text-3xl sm:text-7xl md:text-8xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-sky-300 to-white leading-[1.1] sm:leading-[1.05]">
              UI/UX &amp; WEB CRAFT.
            </h1>
          </Reveal>
        </div>
