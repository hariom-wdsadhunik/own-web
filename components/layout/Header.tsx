        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-mono tracking-widest text-gray-400" aria-label="Main Navigation">
            ...
            <button
              ...
              className="px-4 py-2 text-xs font-mono tracking-wider text-cyan-300 bg-cyan-500/10 border border-cyan-400/40 rounded-md hover:bg-cyan-500/20 hover:border-cyan-400 transition-all focus-visible:ring-1 focus-visible:ring-cyan-400 font-bold"
            >
              START A PROJECT
            </button>
          </nav>
          ...
          <div className="md:hidden fixed inset-0 top-[56px] z-40 bg-[#07080a]/98 backdrop-blur-2xl flex flex-col justify-between p-6 overflow-y-auto">
            ...
            <div className="space-y-6 pt-6 border-t border-white/10 pb-6">
              ...
              <button
                ...
                className="w-full min-h-[44px] py-3 px-6 text-center font-display text-xs tracking-widest text-slate-950 bg-cyan-400 rounded-lg hover:bg-cyan-300 font-bold flex items-center justify-center gap-2 transition-colors shadow-lg shadow-cyan-500/20"
              >
