# Portfolio Production Route Inventory
...
| Route Path | Type | Indexable? | Page Purpose | Status |
| :--- | :--- | :--- | :--- | :--- |
...
| `/design-system` | Static (SSG) | No (`noindex`) | Development Design System Showcase | Verified |
| `/sitemap.xml` | Dynamic | Yes | XML Sitemap for Search Indexing | Verified |
| `/robots.txt` | Dynamic | Yes | Robots Indexing Directives | Verified |